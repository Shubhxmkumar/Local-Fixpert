...
//   return (
//     <section
//       className="relative w-full h-[600px] bg-cover bg-center flex items-center poppins-bold"
//       style={{ backgroundImage: `url(${about})` }}
//     >
//       {/* Left Gradient Overlay (30% width) */}
//       <div className="absolute left-0 top-0 h-full w-[50%] bg-gradient-to-r from-yellow-50/95  via-yellow-50/70 to-transparent"></div>

//       {/* Text Content */}
//       <div className="relative z-10 w-full md:w-[35%] pl-10 md:pl-20 text-gray-800">
...
//         <button className="mt-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow hover:bg-blue-700 transition-all">
//           Learn More
//         </button>
//       </div>
//     </section>
