...
// import electrician from "../assets/home-page/services-assets/wallpainter.png";
// import pest from "../assets/home-page/services-assets/housecleaning.png";
...
//               className="bg-white shadow-md hover:shadow-lg transition-all duration-300 rounded-2xl overflow-hidden flex flex-col items-center text-center p-5 cursor-pointer"
//             >
